...
from chisurf.macros.core_fit import add_fit, load_project, save_project
...
def run_smoke_tests():
    ...
    try:
        ...
        print("  - Fit added successfully via global resolution.")
    except Exception as e:
        print(f"  - FAILED: {e}")
        traceback.print_exc()
        return False
    ...
    try:
        ...
        print("  - Fit parameters updated (simulated).")
    except Exception as e:
        print(f"  - FAILED: {e}")
        return False
