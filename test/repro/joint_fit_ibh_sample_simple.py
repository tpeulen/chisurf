...
def main():
    ...
    fit_d0 = chisurf.core.fitting.fit.FitGroup(
        data=decay_dd_d0, model_class=chisurf.core.models.description.tcspc_lifetime
    )
    ...
    fit_da = chisurf.core.fitting.fit.FitGroup(
        data=decay_dd_da, model_class=chisurf.core.models.description.tcspc_fret_gaussian
    )
