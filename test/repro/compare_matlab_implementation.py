...
def analyze_matlab_parameters():
    ...
    matlab_files = ["TK_Create2DFDC_04.m", "TK_FitF_2DMEM_07.m", "TK_MyMain_Fit_2DMEM_04.m"]
...
def create_optimized_test():
    ...
    print("Using MATLAB-like parameters:")
    ...
    try:
        ...
        print("Success! Created matrices:")
...
def test_optimized_fitting(fdc_data, matlab_data):
    ...
    print("  max_iterations: 5000 (increased from 100)")
    print("  tolerance: 1e-6 (tighter tolerance)")
...
def main():
    ...
    if fdc_data is not None:
        test_optimized_fitting(fdc_data, matlab_data)
