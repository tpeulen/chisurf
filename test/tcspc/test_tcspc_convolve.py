...
class Tests(unittest.TestCase):
    ...
    def test_convolve_lifetime_spectrum(self):
        ...
        reference = np.array(
            [5.89968061e-07, 2.31003027e-05, 4.93647051e-04, 5.66130319e-03,
    ...
    def test_convolve_lifetime_spectrum_periodic(self):
        ...
        reference = np.array(
            [0.01349279, 0.01265528, 0.01187299, 0.0111453, 0.01047781,
             0.00988954, 0.00942859, 0.00920112, 0.00941947, 0.01047207,
             0.01300804, 0.01801289, 0.02683028, 0.04107082, 0.06235651,
             0.09189391, 0.12994681, 0.17536417, 0.22536447, 0.2757396,
             0.32151223, 0.3579037, 0.38132893, 0.39010378, 0.3846532,
             0.36719537, 0.34105902, 0.3098873, 0.27696618, 0.24481629,
             0.21506784, 0.18854985, 0.16549041, 0.14573731, 0.12894272,
             0.11469145, 0.10257583, 0.0922315, 0.08334887, 0.07567204,
             0.06899235, 0.06314075, 0.05798045, 0.05340064, 0.04931141,
             0.04563952, 0.04232512, 0.03931909, 0.03658091, 0.03407702,
             0.03177942, 0.02966466, 0.02771292, 0.0259074, 0.02423371,
             0.02267945, 0.02123389, 0.01988763, 0.01863244, 0.01746101,
             0.01636684, 0.0153441, 0.01438755, 0.01349245]
        )
        self.assertEqual(
            np.allclose(decay, reference),
            True
