...
def main():
    ...
    try:
        ...
        print(
            f"MicrotimeHistogram instance has on_time_step_changed method: {has_on_time_step_changed}"
        )
        ...
        print(
            f"MicrotimeHistogram instance has update_micro_time_resolution method: {has_update_micro_time_resolution}"
        )
        ...
        if has_time_step and has_time_step_attr:
            ...
            print(
                f"After setting time_step to 'invalid', value is: {invalid_value} (should still be {new_value})"
            )
            ...
            print(
                f"After setting time_step to -1.0, value is: {negative_value} (should still be {new_value})"
            )
    ...
    print(
        "4. Modified update_micro_time_resolution to use time_step attribute instead of updating lineEdit_4 directly"
    )
    print(
        "5. Modified add_to_chisurf to use time_step attribute instead of reading from lineEdit_4"
    )
    print(
        "6. Modified compute_microtime_histogram to use time_step attribute instead of reading from lineEdit_4"
    )
