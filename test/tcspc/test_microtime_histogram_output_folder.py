...
def main():
    ...
    try:
        ...
        print(
            f"MicrotimeHistogram instance has update_output_filename method: {has_update_output_filename}"
        )
        ...
        print(
            f"MicrotimeHistogram instance has compute_microtime_histogram method: {has_compute_microtime_histogram}"
        )
