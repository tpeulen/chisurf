"""ndX's gates and ChiSurf's regions are the same thing, checked against it.
...
ndX's own ``get_mask`` excludes. Asserting that against the real
...
def _agrees(selections, data, axes=(0, 1)):
    """Whether the bridge and ndX exclude the same points."""
