...
Nothing here is PDA3c-specific machinery: ChiSurf's global fit concatenates the
...
def _three_colour_fit(n_bursts=2500, seed=31):
    """A PDA3c fit over simulated bursts, only R(GR) free."""
...
def _two_colour_fit(seed=7):
    ...
    fit = _make_pda_fit(Pda2cGaussianDistanceModel)
    model = fit.model
