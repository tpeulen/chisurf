...
Covers :class:`chisurf.core.models.pda2c.common.Pda2cFitSettings` and
:func:`~chisurf.core.models.pda2c.common.pda_weighted_residuals` — the choice of
...
def _gaussian_fit():
    ...
    return fit_mod.Fit(model_class=Pda2cGaussianDistanceModel, data=_make_pda_data())
...
def test_axis_selection_resets_the_binning_range():
    from chisurf.core.models.pda2c.common import Pda2cFitSettings
...
def test_every_pda_model_carries_editable_fit_settings():
    ...
    fit = _gaussian_fit()
    assert isinstance(fit.model.fit_settings, Pda2cFitSettings)
...
def test_statistics_rescale_the_model_to_the_data_counts():
    ...
    from chisurf.core.models.pda2c.common import pda_weighted_residuals
...
def test_view_specs_expose_the_fit_histogram_panel(spec_name):
    ...
    from chisurf.core.models.pda2c.common import PDA_AXES, PDA_STATISTICS
