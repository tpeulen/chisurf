...
s2delta_val, delta = s2delta(
    s2_donor=s2_donor, s2_acceptor=s2_acceptor, r_inf_AD=model.r_sensitized.value, r_0=model.r0
)
expected_kappa_sq = kappasq(delta=delta, sD2=s2_donor, sA2=s2_acceptor, beta1=0.0, beta2=0.0)
...
test_values = [(0.05, 0.05, 0.01), (0.15, 0.20, 0.03), (0.25, 0.10, 0.05), (0.30, 0.30, 0.10)]
...
for r_d, r_a, r_s in test_values:
    ...
    s2delta_val, delta = s2delta(
        s2_donor=s2_donor, s2_acceptor=s2_acceptor, r_inf_AD=r_s, r_0=model.r0
    )
    expected_kappa_sq = kappasq(delta=delta, sD2=s2_donor, sA2=s2_acceptor, beta1=0.0, beta2=0.0)
