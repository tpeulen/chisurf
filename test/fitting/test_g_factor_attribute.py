...
def main():
    ...
    try:
        ...
        print(
            f"MicrotimeHistogram instance has on_gfactor_changed method: {has_on_gfactor_changed}"
        )
        ...
        print(
            f"MicrotimeHistogram instance has on_detector_selection_changed method: {has_on_detector_selection_changed}"
        )
        ...
        if has_g_factor and has_g_factor_attr:
            ...
            print(
                f"After setting g_factor to 'invalid', value is: {invalid_value} (should still be {new_value})"
            )
    ...
    print(
        "6. Modified on_detector_selection_changed to update g_factor attribute when a tttr_channeldefinition is selected"
    )
