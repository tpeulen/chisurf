...
Here, :emphasis:`NeGFP` = 7.4, :emphasis:`NSNAP` \= 12.1 and :emphasis:`Napp,PIE` = 91. The amplitudes at zero correlation time, G(:emphasis:`tc` = 0), are therefore: GeGFP(0) = 0.135, GSNAP(0) = 0.082, and GPIE(0) = 0.011.
