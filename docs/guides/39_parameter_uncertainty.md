...
tags: [guides, uncertainty, sampling, fitting]
---
...
├── chains/           # one file per run: chi2r, lnprior, then the parameters
...
```python
report = chisurf.core.fitting.fit.sample_fit(
    fit=fit, target_directory='./sampling', steps=20000, n_runs=4,
    chain_format='hdf5',
)
```
