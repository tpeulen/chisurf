...
| --- | --- | --- |
| `calculator/hub` | Main:Tools:Calculators | Hub that groups the FRET-line, FRET/homoFRET, FCS, phasor-plot and κ²-distribution calculators and embeds the selected one in a two-panel view. |
