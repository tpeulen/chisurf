...
--------------------------------
Fourteen control families in :mod:`chimol.renderer.ui` came out of
...
* ``chisurf/plugins/chimol/chimol/renderer/ui/<module>.py`` -- the skeleton,
...
UI_DIR = pathlib.Path("chisurf/plugins/chimol/chimol/renderer/ui")
...
from chisurf.plugins.chimol.chimol.renderer.ui import {module}
...
def render_gallery_rows(module: str, cls: str) -> str:
    ...
    return (
        ...
        f'    """The {module} family."""\n'
        f"    from chisurf.plugins.chimol.chimol.renderer.ui import {module} as m\n\n"
        f"    return [\n"
