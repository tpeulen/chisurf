...
class AVProperties(QtWidgets.QWidget):
    @chisurf.gui.decorators.init_with_ui(ui_filename="av_property.ui")
    def __init__(self, av_type: str = "AV1"):
    ...
    def linker_length(self, v: float):
    ...
    def initial_linker_sphere(self, v: float):
    ...
    def initial_linker_sphere_min(self, v: float):
    ...
    def initial_linker_sphere_max(self, v: float):
