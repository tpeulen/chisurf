...
class WizardTTTRFileFormat(QtWidgets.QWizardPage):
    ...
    def updateUI(self):
        ...
        self.plainTextEdit.setPlainText(json.dumps(self.settings["header"], indent=2))
    ...
    def __init__(self, *args, **kwargs):
        ...
        chisurf.gui.decorators.lineEdit_dragFile_injector(self.lineEdit_16, call=self.read_tttr)
