...
class SawNuChainModelWidget(fret.SawNuModel, LifetimeModelWidgetBase):
    """Widget for the SAW-ν polymer FRET distance-distribution model."""
    ...
    def __init__(self, fit: "Fit", **kwargs):
        """Initialize the SAW-ν FRET widget."""
        ...
        # SAW-ν polymer parameters: RMS inter-dye distance and Flory exponent.
        self.layout.addWidget(
            cs.gui.widgets.fitting.widgets.make_fitting_parameter_widget(self._r_rms))
        self.layout.addWidget(
            cs.gui.widgets.fitting.widgets.make_fitting_parameter_widget(self._nu))
