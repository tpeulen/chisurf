...
_RUN_SETTING_HELP = {
    ...
    "n_runs": (
        "Independent runs. Their disagreement is the R-hat that says whether the "
...
class FittingControlsModel:
    ...
    def __init__(
        self,
        controller,
        dataset_labels: typing.Sequence[tuple[str, str]] = (),
    ...
    def set_dataset_labels(self, labels: typing.Sequence[tuple[str, str]]) -> None:
...
class OptimizationSettingsModel:
        ...
        for section in cs.core.fitting.sample.optimizer_settings():
            ...
            if value is None:
                value = (
                    ...
                    else (0.0 if section.get("kind") == "float" else 0)
                )
            ...
            "sections": [
                {
                    ...
                    "attr": "method",
                    "label": "Sampler",
                    "options_source": "sampler_options",
                    "call": "sampler_changed",
    ...
    def sampling_settings(self) -> dict:
        ...
        values["samplers"] = {name: dict(settings) for name, settings in self._per_sampler.items()}
        return values
