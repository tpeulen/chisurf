...
* **AssetPack** — games emit semantic draw calls (``draw("dye", "atto488")``)
  ...
  swappable without touching game code. :class:`ProceduralPack` draws that
  vocabulary as signed-distance shapes with no image files at all.
...
The top-down action systems once ported here (sheet-animated actors, steering
behaviors, tile maps, the room camera, weather) left with Ninja Adventure for
Lumis Quest, whose vendored copy of this engine keeps them.
