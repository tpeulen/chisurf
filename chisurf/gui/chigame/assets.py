        ...
        **hints
        ...
        if kind == "photon":
            ...
            if name == "halo":
                ...
                return Appearance(
                    shape=GLOW, color=(*rgb, 0.30), param=0.9, softness=0.5, scale=3.4
                )
        ...
        if kind == "tile":
            return Appearance(
                shape=RECT,
                color=color or self.PALETTE.get(name, self.PALETTE["grass"]),
                softness=0.0,
            )
        if kind == "wall":
        ...
        if kind == "aura":
            return Appearance(
                shape=RING, color=color or self.PALETTE["accent"], param=0.7, softness=0.15
            )
        if kind == "ui":
            variants = {
                ...
                "frame": Appearance(
                    shape=ROUND, color=(0.10, 0.11, 0.15, 0.98), param=0.06, softness=0.0
                ),
...
TRACKS: dict[str, dict] = {
    ...
    "overworld": {
        ...
        "pad": {
            ...
            "detune": 8.0,
            "sustain": 0.85,
            "notes": [[0, 8], [7, 8], [9, 8], [5, 8], [0, 8], [7, 8], [5, 8], [7, 8]],
        },
        "bass": {
            "wave": "triangle",
            "gain": 0.26,
    ...
    "town": {
        ...
        "harmony": {
            ...
            "gain": 0.10,
            "sustain": 0.8,
            "notes": [[4, 6], [0, 6], [4, 6], [-2, 6], [-1, 6], [0, 6], [-2, 6], [4, 6]],
        },
        "bass": {
            "wave": "triangle",
            "gain": 0.24,
    ...
    "victory": {
        ...
        "melody": {
            ...
            "gain": 0.32,
            "sustain": 0.7,
            "notes": [[0, 1], [4, 1], [7, 1], [12, 2], None, [12, 1], [16, 1], [19, 4]],
        },
        "bass": {
            "wave": "triangle",
            "gain": 0.26,
