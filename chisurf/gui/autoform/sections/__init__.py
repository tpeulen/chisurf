...
from . import (
    ...
    code_editor_section,  # noqa: F401  (registers the "code_editor" section)
    data_source_section,  # noqa: F401  (registers the "data_source" section)
    data_table_section,  # noqa: F401  (registers the "data_table" section)
    decay_conv_section,  # noqa: F401  (registers the "decay_conv" section)
    decay_panel_section,  # noqa: F401  (registers the "decay_panel" section)
