...
:class:`chimol.renderer.ui.text_editor.TextEditor`, the port of
ImGuiColorTextEdit that chimol draws in its own viewport chrome, hosted in a
``QWidget`` by :class:`chimol.renderer.ui.qt_host.ControlHost`.
...
``language`` : str, default ``"python"``
    One of the names in
    :func:`chimol.renderer.ui.text_editor.shipped_languages`, case-insensitive
