...
@click.option(
    "--container", is_flag=True, help="Also write the result into <dat_file>.pto, beside the traces"
)
def compute(
    dat_file, min_states, max_states, max_iter, vbem_max_iter, limit, seed, output, container
):
