...
class AcquisitionSettingsWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        self.chunk_size_spinbox.setToolTip(
            "Number of photons to read per chunk (each photon = 32 bits)"
        )
        ...
        self.real_time_sim_checkbox.setToolTip(
            "Pace simulation to roughly 1s wall time = 1s sim time"
        )
    ...
    def _on_device_type_changed(self, device_type: str):
        ...
        try:
            if device_type == "Simulation":
                ...
                from chisurf.plugins.core.acq.tcspc_devices.picoquant.setup_dialog import (
                ...
                from chisurf.plugins.core.acq.tcspc_devices.bh_spc.card_setup_dialog import (
