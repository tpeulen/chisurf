...
def mmfdb_chinet_to_node_editor_graph(
    operation_id: str,
    artifacts: list[dict[str, Any]],
    parameters: list[dict[str, Any]],
    edges: list[dict[str, Any]],
) -> dict[str, Any]:
    """Convert MMFDB chinet artifacts to node editor graph format.
    ...
    def _add_node(
        ...
        entry = {
            "id": node_id,
            "title": title,
            "inputs": inputs or [{"name": "in", "type": "mmfdb"}],
            "outputs": outputs or [{"name": "out", "type": "mmfdb"}],
            "type": node_type,
            "config": config or {},
            "collapsed": False,
            "z": 1.0,
    ...
    _add_node(
        ...
        "project",
        inputs=[],
        outputs=[{"name": "datasets", "type": "mmfdb"}, {"name": "fits", "type": "mmfdb"}],
    ...
    # Add dependency edges from mmfdb_edge
    for edge in edges:
    ...
    return {
        ...
        "meta": {
            ...
            "schema_name": "mmfdb.chinet.node_editor.v1",
...
def mmfdb_version_graph_to_node_editor_graph(
    project_id: str,
    ...
    for v in versions:
        ...
        entry = {
            "id": nid,
            "title": title,
            "inputs": [{"name": "parent", "type": "mmfdb"}],
            "outputs": [{"name": "children", "type": "mmfdb"}],
            "type": "version",
            "config": {
                "version_id": vid,
                "version_number": vn,
    ...
    return {
        ...
        "meta": {
            ...
            "schema_name": "mmfdb.version_graph.node_editor.v1",
