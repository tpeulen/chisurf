...
class _EntityModel:
    ...
    ``MMFDBDetailWidget``'s ``commitRequested`` semantics.
    """
...
class EntityForm(QtWidgets.QWidget):
    """AutoForm-rendered entity detail form (drop-in for MMFDBDetailWidget)."""
    ...
    def get_data(self) -> dict[str, Any]:
        """Collect form values into a record dict (matching MMFDBDetailWidget)."""
        out: dict[str, Any] = {}
        for fs in self._specs:
