"""AutoForm-driven MMFDB login dialog.
...
panel, so reconnecting to a different MMFDB server is possible without cluttering
the everyday login.
"""
...
class ConnectionAuthDialog(QtWidgets.QDialog):
    ...
    def __init__(
        ...
        self.setWindowTitle(f"MMFDB login — {user}")
