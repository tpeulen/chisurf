...
A thin Qt widget over the ``mmfdb.protocols.*`` RPC handlers (PRD-23: logic in the
...
``MMFDBClient``) so the in-flight mmfdb-admin dock rewrite (``OVERHAUL_PLAN.md``) slots it
