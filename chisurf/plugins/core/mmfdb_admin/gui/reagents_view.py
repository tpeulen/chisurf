...
A thin Qt widget over the ``mmfdb.samples.reagents.*`` RPC handlers (PRD-23: logic in the
...
**standalone** (constructed with an ``MMFDBClient``) so it slots into the mmfdb-admin
