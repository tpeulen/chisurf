...
This is the **only** per-entity hardcoding in the mmfdb-admin GUI. It contains
...
class EntitySpec:
    """Wiring specification for one MMFDB entity type.
    ...
    rpc : str
        RPC namespace — resolves to ``mmfdb.{rpc}.list/get/save/delete``.
    id_field : str
...
ENTITY_REGISTRY: list[EntitySpec] = [
    ...
    EntitySpec(
        ...
        category="mmfdb_setup_detector_channel",
        rpc="setups.detector_channels",
        id_field="id",
        list_key="detector_channels",
        group="Experiments & data",
        writable=False,
        schema_type="mmfdb_setup_detector_channel",
    ),
    EntitySpec(
        key="pie_window",
        title="PIE Windows",
        category="mmfdb_setup_pie_window",
        rpc="setups.pie_windows",
        id_field="id",
        list_key="pie_windows",
        group="Experiments & data",
        writable=False,
        schema_type="mmfdb_setup_pie_window",
    ),
    EntitySpec(
        key="fcs_pair",
        title="FCS Pairs",
        category="mmfdb_setup_fcs_pair",
        rpc="setups.fcs_pairs",
        id_field="id",
        list_key="fcs_pairs",
        group="Experiments & data",
        writable=False,
        schema_type="mmfdb_setup_fcs_pair",
    ),
    EntitySpec(
        key="device",
        title="Devices",
