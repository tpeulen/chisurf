...
Drives the thin read-only view over a real in-process MMFDBClient: list pipelines, and on
...
from chisurf.plugins.core.mmfdb_admin.gui.pipelines_view import PipelinesView
