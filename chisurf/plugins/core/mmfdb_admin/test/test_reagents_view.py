...
Drives the thin view over a real in-process MMFDBClient RPC layer: list lots, filter by
...
from chisurf.plugins.core.mmfdb_admin.gui.reagents_view import ReagentLotsView
