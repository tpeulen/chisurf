...
class FilterCalcClient:
    ...
    def compute_mfd_from_files(
        self, total_par_path, total_perp_path, species_par_paths, species_perp_paths
    ) -> dict[str, Any]:
        return self._client.call(
            "fcs_filter.compute_mfd_from_files",
            {
