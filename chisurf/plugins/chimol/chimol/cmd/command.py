...
from .inspect import DebugMixin, InspectMixin
...
class Cmd(LoaderCommands, SelectionMixin, SettingsMixin, RenderingMixin, PresetMixin, AnimationMixin, MeasurementMixin, InteractionMixin, DebugMixin, EditingMixin, InspectMixin, LifecycleMixin, ExportMixin, SessionMixin, SymmetryMixin, VolumeMixin, BaseCmd):
