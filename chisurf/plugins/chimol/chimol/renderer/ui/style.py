...
``TextDisabled`` a flat mid-grey; chimol's are slightly blue-cool and lighter
...
# The palette
# --------------------------------------------------------------------------
# chimol's own three (see the module docstring for why they are not the
# reference's).
TEXT = (235, 235, 240)
DIM = (150, 150, 160)
GOLD = (245, 225, 128)
...
# --------------------------------------------------------------------------
# chimol's own, kept at their shipped values
# --------------------------------------------------------------------------
...
#: chimol turns a held thumb **gold**; the reference brightens the same blue
...
#: chimol's tick is **green**; the reference's :data:`CHECK_MARK` is the
#: accent blue. Green separates "this is on" from "this is selected", which
#: share a colour in the reference.
CHECK_ON = (90, 230, 120)
#: chimol's buttons are a desaturated slate rather than the reference's
