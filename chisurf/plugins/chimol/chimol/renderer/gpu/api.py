"""The GPU surface the engine is written against.

Import it the way the engine used to import the binding::
...
-----------------------------
The engine touches thirty-eight ``wgpu.*`` names. Thirty-four are WebGPU
...
class _Gpu:
    ...
    def __repr__(self) -> str:
        ...
        return f"<chimol gpu via {backend_name()!r}>"
