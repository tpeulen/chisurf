...
:mod:`chimol.host.keys` and :mod:`chimol.host.events` took **Qt's** numeric
...
process -- ``chimol`` is meant to run with Qt as an *option*, and
...
from a ``view.json`` and needs a ``QWidget`` for a custom section; a chimol
