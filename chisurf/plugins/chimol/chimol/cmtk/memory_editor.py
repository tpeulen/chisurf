...
mapped-back GPU buffer (VRAM). :mod:`chimol.renderer.memory_probe` is what
enumerates them; this file only knows how to draw one.
...
AutoForm section and the chimol dock both do.
"""
