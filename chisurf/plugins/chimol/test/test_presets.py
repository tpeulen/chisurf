...
from chisurf.plugins.chimol.chimol.colors import (
    CHAIN_COLOR_CYCLE,
    _build_chain_color_array,
    get_pymol_color,
)
from chisurf.plugins.chimol.chimol.cmd.presets import PresetMixin
...
def test_the_menu_offers_pymols_presets_and_runs_the_real_ones():
    ...
    """
    from chisurf.plugins.chimol.chimol.object_menus import ACTION_MENU
