...
Now the canvas owns a :class:`~chimol.cmtk.router.Router`: the chrome is a
...
from chimol.cmtk.events import LEFT_BUTTON, RIGHT_BUTTON
from chimol.cmtk.router import Consumed, Event, OverlayStack, Pass, Router
