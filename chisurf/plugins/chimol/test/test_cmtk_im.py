...
from chimol.cmtk.drawlist import DRAW_FLAGS_CLOSED, DrawList
from chimol.cmtk.im import ButtonFlags, Context, ImWidget
from chimol.cmtk.painter import fill_circle, fill_convex, polyline
from chimol.cmtk.quad_painter import FLOATS_PER_VERTEX, QuadPainter
...
def test_the_quad_painter_polyline_matches_the_fallback_geometry():
    ...
    from chimol.cmtk.painter import line
