...
from chisurf.plugins.chimol.chimol import keybindings as kb
...
def test_the_table_and_the_shipped_config_agree():
    ...
    notice.
    """
    from chisurf.plugins.chimol.chimol.config import _load_display_config
...
def test_the_settings_panel_offers_every_binding_as_an_editable_field():
    ...
    from chisurf.plugins.chimol.chimol.renderer.settings_window import build_model
...
def test_the_help_menu_offers_the_overlay():
    from chisurf.plugins.chimol.chimol.app.menu_bar import HELP_MENU
