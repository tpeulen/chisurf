"""Painter-level tests for the ported hex editor and the memory probe.
...
from chimol.host.keys import KEY_DOWN, KEY_RIGHT
...
def test_a_zero_byte_is_dimmed_when_asked_and_not_when_not():
    ...
    from chimol.cmtk.style import TEXT_DISABLED
