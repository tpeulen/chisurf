...
from chimol.chrome.gui import GuiRow, InternalGui, char_width
...
def test_the_block_shows_pymols_own_matrix(gui):
    ...
    """
    from chimol.chrome.mouse_modes import rows_for
...
def test_the_transcription_still_matches_pymol():
    ...
    from chimol.chrome.mouse_modes import MODE_BINDINGS, MODE_NAMES
...
def sequences(gui):
    ...
    from chimol.chrome.gui import SequenceRow
...
def test_the_letters_take_the_structures_colours(sequences):
    ...
    """
    from chimol.chrome.gui import _residue_color
...
def test_the_mode_line_cycles_within_pymols_ring(gui):
    ...
    """
    from chimol.chrome.mouse_modes import MODE_RINGS
...
def test_the_table_and_the_mouse_read_the_same_bindings():
    ...
    from chimol.chrome.mouse_modes import action_of, rows_for
...
def test_ctrl_shift_is_its_own_row_not_a_ctrl_row():
    ...
    QtWidgets.QApplication.instance() or QtWidgets.QApplication([])
    from chimol.chrome.mouse_modes import modifier_of
...
def test_the_wheel_bindings_come_from_the_table_too():
    ...
    QtWidgets.QApplication.instance() or QtWidgets.QApplication([])
    from chimol.chrome.mouse_modes import wheel_action_of
...
def test_window_states_survive_a_restart(tmp_path, monkeypatch):
    ...
    from chimol.chrome import window_state
