...
def test_a_window_body_is_told_where_the_pointer_is():
    seen: list[tuple] = []
    gui = _gui()
    gui.add_window(GuiWindow(key="panel", title="Panel", x=40.0, y=40.0,
                             w=200.0, h=120.0,
...
def test_the_body_rect_is_the_one_presses_get():
    ...
    rects: list = []
    gui = _gui()
    window = GuiWindow(key="panel", title="Panel", x=40.0, y=40.0, w=200.0, h=120.0,
...
def test_a_panel_that_throws_does_not_take_the_frame_with_it():
    ...
    gui = _gui()
    gui.add_window(GuiWindow(key="panel", title="Panel", x=40.0, y=40.0,
                             w=200.0, h=120.0, on_hover=angry))
