...
Why this exists
---------------
The controls in :mod:`emtk` are tested against a recording
...
the chrome uses, laid out by the same :class:`~emtk.layout.Layout`
a host would use.
...
def _rows(module_name: str) -> list[tuple]:
    ...
    ----------
    module_name : str
        Bare module name inside ``emtk``, e.g. ``"buttons"``.
...
def _widgets_rows() -> list[tuple[str, Callable]]:
    ...
    from emtk.widgets import basic as w
...
def _buttons_rows() -> list[tuple]:
    ...
    The list dot is not here -- it belongs to :mod:`~emtk.widgets.text`
    beside ``BulletText``, so that one dot has one implementation.
    """
    from emtk.widgets import buttons as b
...
def _text_rows() -> list[tuple]:
    """The Text family."""
    from emtk.widgets import text as t
...
def _sliders_rows() -> list[tuple]:
    """The Slider family."""
    from emtk.widgets import sliders as s
...
def _drag_rows() -> list[tuple]:
    """The Drag family."""
    from emtk.widgets import drag as d
...
def _inputs_rows() -> list[tuple]:
    """The Input family."""
    from emtk.widgets import inputs as i
...
def _combo_rows() -> list[tuple]:
    ...
    """
    from emtk.widgets import combo as c
...
def _selection_rows() -> list[tuple]:
    ...
    from emtk.widgets import selection as s
...
def _color_rows() -> list[tuple]:
    """The Colour family."""
    from emtk.widgets import color as c
...
def _menus_rows() -> list[tuple]:
    """Menus and popups."""
    from emtk.widgets import menus as m
...
def _tabs_rows() -> list[tuple]:
    """The TabBar family."""
    from emtk.widgets import tabs as t
...
def _tables_rows() -> list[tuple]:
    ...
    from emtk.widgets import tables as tb
...
def _dragdrop_rows() -> list[tuple]:
    ...
    """
    from emtk.widgets import dragdrop as dd
...
def _layout_rows() -> list[tuple]:
    ...
    """
    from emtk import layout as lay
    from emtk.widgets import basic as w
