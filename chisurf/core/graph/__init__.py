...
ChiSurf's fitting layer models a *computation* graph (nodes, ports, links).
This package is the plain graph-theory layer underneath that vocabulary: containers with
