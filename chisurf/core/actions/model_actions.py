...
def set_model_correction(
    correction_type: str, value: typing.Any, fit_index: typing.Optional[int] = None
):
...
def append_fit_to_global(fit_index: int, global_fit_index: typing.Optional[int] = None):
    ...
    if fit is None:
        cs.logging.warning(
            "actions.model.append_fit_to_global: global fit resolution returned None; aborting"
        )
        return {}
    try:
        cs.logging.info(
...
def set_model_background_curve(idx: int, curve_name: str, fit_index: typing.Optional[int] = None):
