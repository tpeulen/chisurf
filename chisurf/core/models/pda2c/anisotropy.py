...
class Pda2cAnisotropyNuisance(FittingParameterGroup):
...
class Pda2cAnisotropySpecies(FittingParameterGroup):
...
class Pda2cAnisotropyModel(Pda2cDiagnosticsMixin, ModelCurve):
    ...
    def __init__(
        ...
        nuisance: Pda2cAnisotropyNuisance | None = None,
        species: Pda2cAnisotropySpecies | None = None,
        ...
        **kwargs,
        ...
        nuisance : Pda2cAnisotropyNuisance, optional
            Nuisance parameter group.
        species : Pda2cAnisotropySpecies, optional
        ...
        **kwargs
        ...
        if nuisance is None:
            nuisance = Pda2cAnisotropyNuisance(
        ...
        if species is None:
            species = Pda2cAnisotropySpecies(
        ...
        # is binned, and under which counting statistic (see Pda2cFitSettings).
