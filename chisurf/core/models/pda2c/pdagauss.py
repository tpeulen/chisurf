...
:class:`Pda2cGaussianDistances` and :class:`Pda2cGaussianDistanceModel`
were previously defined in :mod:`cs.core.models.pda2c.simple` and have
...
class Pda2cGaussianDistances(FittingParameterGroup):
...
class Pda2cGaussianDistanceModel(Pda2cDiagnosticsMixin, ModelCurve):
    """PDA model with a Gaussian distance distribution."""

    name = "PDA2c-Gaussian-distance"
    ...
    def __init__(
        ...
        distances: Pda2cGaussianDistances | None = None,
        ...
        **kwargs,
        ...
        distances : Pda2cGaussianDistances, optional
        ...
        **kwargs
        ...
        if nuisance is None:
            nuisance = Pda2cFretNuisance(name="pda_fret_nuisance", fit=fit, **kwargs)
        if distances is None:
            distances = Pda2cGaussianDistances(name="pda_distances", fit=fit, **kwargs)
    ...
    def update_model(
        ...
        **kwargs
        ...
        try:
            cs.logging.debug(
                {
                    "model": "Pda2cGaussianDistanceModel",
