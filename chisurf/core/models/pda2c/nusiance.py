...
``chisurf.core.models.pda2c.simple.Pda2cGaussianDistanceModel``.
"""
...
class Background(FittingParameterGroup):
    ...
    Examples
    --------
    >>> from chisurf.core.models.pda2c.nusiance import Background
    >>> bg = Background()
    >>> (bg.bg0, bg.bg1)
    (0.0, 0.0)
    >>> bg.bg0 = 5.0
...
class Pda2cFretNuisance(FittingParameterGroup):
...
class Pda2cPhotonRange(FittingParameterGroup):
