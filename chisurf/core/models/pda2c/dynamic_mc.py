...
two-state model (:mod:`chisurf.core.models.pda2c.dynamic`) has a closed-form
...
:func:`chisurf.core.models.pda2c.common.green_probability_from_efficiency`). The
...
class Pda2cDynamicNStates(RateMatrixMixin, FittingParameterGroup):
...
class Pda2cDynamicNStateModel(Pda2cModelMixin, ModelCurve):
    ...
    def __init__(
        ...
        states: Pda2cDynamicNStates | None = None,
        n_hist: int = 81,
        seed: int = 1,
        **kwargs,
    ):
        ...
        states : Pda2cDynamicNStates, optional
    ...
    def observation_time(self) -> float:
        ...
        See :func:`chisurf.core.models.pda2c.common.pda_observation_time`. The
