...
``cs.core.experiments.pda2c.Pda2cReader``. The models are built from
...
class ProbCh0(FittingParameterGroup):
    ...
    normalized amplitudes and probability spectrum::
        ...
        >>> from cs.core.models.pda2c.simple import ProbCh0
        >>> p = ProbCh0()
...
class Pda2cSimpleModel(Pda2cDiagnosticsMixin, ModelCurve):
    ...
    def __init__(
        ...
        nuisance : Pda2cPhotonRange, optional
