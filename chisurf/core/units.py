...
reader asks for a factor, and neither invents one.

The broader plan — parameters, axes and files carrying units through the whole
stack — is [PRD-84](/prds/prd-84.md). This is the vocabulary half of it.
"""
