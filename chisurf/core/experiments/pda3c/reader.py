...
A PDA3c dataset is a **burst table**, not a curve: five photon counts per burst,
...
class Pda3cSimulatorReader(ExperimentReader):
    ...
    checks. This makes the PDA3c model immediately usable — and lets a fit be
