"""Password authentication handlers for MMFDB users."""
...
def login_handler(user_id: str, password: str = "") -> dict[str, Any]:
    """Authenticate an MMFDB user without exposing password hashes.
...
def change_password_handler(
    ...
    """Change an MMFDB user's password using MMFDB authorization rules."""
    import sqlite3
